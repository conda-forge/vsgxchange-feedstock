...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/vsgxchange-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/vsgxchange-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install vsgxchange
```
...
It is possible to list all of the versions of `vsgxchange` available on your platform:
...
```
pixi search vsgxchange --channel conda-forge
```
